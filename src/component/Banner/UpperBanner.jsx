    ...
    <>
      ...
      <section className="section demo-election-section py-0">
        <div className="container is-flex is-justify-content-right">
          <button className="button demo-election-button js-modal-trigger" data-target="modal-js-demo-election">
        ...
        <div className="modal-background"></div>
          <div className="modal-content" style={{ width: "640px" }}>
            <section className="modal-card-body">
              ...
              <figure className="image px-4 mini-uchile-logo" style={{ width: "150px" }}>
                  <img src={process.env.PUBLIC_URL + "/Fotos/logoUchilemorado.png"} />
              </figure>
              <p className="has-text-weight-bold has-text-centered pr-4">Los únicos requisitos para acceder a la prueba es pertenecer a la comunidad de la Universidad de Chile y tener una "Mi Cuenta Uchile" habilitada. Para más información de la cuenta <a href="http://pasaporte.uchile.cl/" target="_blank">ingresa aquí.</a></p>
              </div>
              <a href="https://participa.uchile.cl/psifos/api/app/eleccion-prueba/vote" target="_blank" style={{ textDecoration: "none" }}>
                <button className="mt-2 button demo-enter-button is-outlined" onclick="$('.modal-background').click();">
                    <span className="has-text-white">ACCEDER A ELECCIÓN DE PRUEBA AQUÍ</span>
                </button>
              </a>
            </section>
          </div>
