...
function Description() {
    ...
    return (
        <div className="verify-instruction-descript">
            <div>Para ejecutar el verificador debes ubicar el verificador y el resumen matemático en una misma carpeta. Luego, en la línea de comandos debes ejecutar la siguiente instrucción:</div>
