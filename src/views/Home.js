...
import logo from "../static/assets_home/svg/logo.svg";
import TeamComponent from "./TeamComponent";
import ahevia from "../static/assets_home/img/ahevia.jpg";
import cgomez from "../static/assets_home/img/cgomez.jpg";
import cburgos from "../static/assets_home/img/catalina.jpg";
import eriveros from "../static/assets_home/img/eriveros.jpg";
import clemente from "../static/assets_home/img/clemente.jpg";
import fernanda from "../static/assets_home/img/fernanda.jpg";
import matias from "../static/assets_home/img/matias.jpg";
import grazia from "../static/assets_home/img/grazia.png";
    ...
    <div id="content">
      ...
      <section className="section top-section pt-3 is-hidden-touch">
        <div className="columns">
          <div className="column is-flex pb-0">
            <img src="../static/assets_home/svg/dibujo_1.svg" />
          </div>
      ...
      <section className="section faq-section" id="faq">
        <div className="container">
          ...
          <PreguntasFrecuentes
            ...
            respuesta={
              <div>
                ...
                elecciones estudiantiles locales. Cuando la elección es de alto
                perfil, como por ejemplo, elecciones de cargos públicos de nivel
                nacional (presidente y representantes, etc.), la votación
                electrónica remota es aún un desafío con muchas interrogantes y
                riesgos significativos. La{" "}
                <a
                ...
                conoce un sistema hoy en día que garantice seguridad a un nivel
                adecuado. Participa UChile no es la excepción.
              </div>
            }
          />
          ...
          <PreguntasFrecuentes
            ...
            respuesta={
              <div>
                ...
                voto encriptando los votos con una clave secreta dividida entre
                varios custodios. De hecho, el sistema nunca revela
          ...
          <PreguntasFrecuentes
            ...
            respuesta={
              <div>
                ...
                permiten evidenciar intentos externos o internos de manipulación
                de votos o del total. Otros sistemas cerrados son opacos y sólo
                entregan el resultado sin mayor explicación. En ellos, tanto el
                secreto de un voto individual como la integridad del resultado
                final depende exclusivamente del administrador del sistema
                informático. Los votantes y la comunidad deben depositar su
                confianza en el accionar correcto del administrador, sin
                posibilidad de confirmar si la confianza es merecida o no. Si
                bien Participa UChile no elimina completamente dicha confianza,
                la minimiza significativamente, dándole herramientas al votante
                para confirmar si es merecida o no.
              </div>
            }
          />
          ...
          <PreguntasFrecuentes
            ...
            respuesta={
              <div>
                El sistema permite que, cualquier votante, luego de haber votado
                pueda ingresar nuevamente y reiniciar el proceso de votación,
                emitiendo un nuevo voto que reemplaza al voto anterior. El
                sistema nunca almacena más de un voto por votante. Si bien para
                un votante puede parecer que emite un "segundo voto", eso no es
                efectivo, pues efectivamente está reemplazando su voto. En
                particular, no puede darse el caso que un mismo votante tenga
                dos votos o más, siempre tendrá a lo más un voto. Esta
                funcionalidad es intencional y, si bien no existe en un sistema
                de votación de “lápiz y papel”, es posible de implementar de
                forma segura en un sistema electrónico. Es una medida estándar
                de mitigación parcial contra el problema de la coerción. Si bien
                no es perfecta, es simple de implementar y en entornos de baja
                coerción se considera razonablemente efectiva. Para la
                tranquilidad de todas y todos, podemos aclarar que no es una
                característica errónea o en necesidad de arreglo, pues no viola
